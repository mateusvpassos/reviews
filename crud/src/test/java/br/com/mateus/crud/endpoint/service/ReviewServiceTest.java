...
public class ReviewServiceTest {
    ...
    private Review createObject(){ return new Review(6L, null, null, "MockitoTestOne", Short.valueOf("5"));}
    private Review createObjectUpdate(){ return new Review(6L, null, null, "MockitoTestTwo", Short.valueOf("5"));}
